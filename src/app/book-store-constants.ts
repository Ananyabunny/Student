export class BookStoreConstants {
    ...
    public static VIEW_BOOKS_BY_ORDERS_URL= BookStoreConstants.SPRING_WEB+"books/getBestSellingBooks";

    public static VIEW_4_BOOKS_BY_ORDERS_URL = BookStoreConstants.SPRING_WEB + "books/get4BestSellingBooks";
